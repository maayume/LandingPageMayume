<template>
  <VCard class="px-5 lg:px-0 pt-14 lg:pt-12 flex bg-pink-100 flex-col">
    <h3
      class="
        text-2xl
        font-bold
    ...
    <div class="flex flex-wrap gap-4 hover:gap-6 justify-center m-10">
      <div>
        <div
          class="
            ...
            transition
            duration-500
            hover:scale-90 hover:shadow-violet-600
          "
        >
          <div class="px-6 py-4">
      ...
      <div>
        ...
        >
          ...
          <div class="px-6 pt-4 pb-2">
            <NuxtLink
              to="https://maayume.github.io/xp42-dindin/"
              target="_blank"
              class="
                px-3
                py-1
      ...
      <div>
        ...
        >
          ...
          <div class="px-6 pt-4 pb-2">
            <NuxtLink
              to="https://maayume.github.io/SOUND-GARDEN/"
              target="_blank"
              class="
                px-3
                py-1
